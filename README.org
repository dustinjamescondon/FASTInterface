...
"added-mass" which adds code for a module called
"AeroDynInterface". "AeroDynInterface" exports key functions for
interacting with AeroDyn to be callable by C++.  So this external git
repository is another key part of this project.

Before you build the project you'll need to populate these submodules.
