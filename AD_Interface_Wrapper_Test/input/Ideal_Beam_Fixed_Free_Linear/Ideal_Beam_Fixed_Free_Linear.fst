...
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------
          2   CompElast       - Compute structural dynamics (switch) {1=ElastoDyn; 2=ElastoDyn + BeamDyn for blades; 3=MBDyna}
...
---------------------- INPUT FILES ---------------------------------------------
"../Ideal_Beam/ElastoDyn-fixed.dat"    EDFile          - Name of file containing ElastoDyn or MBDyna input parameters (quoted string)
...
default       DT_Out          - Time step for tabular output (s) (or "default")
          ...
          3   OutFileFmt      - Format for tabular (time-marching) output file (switch) {1=text file [<RootName>.out], 2=binary file [<RootName>.outb], [Envision modification: 4=HDF5 [<RootName>.h5]]; add for combinations (e.g., 3=1+2; 7=1+2+4)}
